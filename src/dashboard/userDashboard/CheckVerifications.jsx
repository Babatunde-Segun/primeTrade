      ...
      {emptyBal ? (
        <div className="verification-boxes">
          ...
          <div className="verification-text">
            ...
            <p>
              Your balance is empty, pls make{" "}
              <span
                onClick={() => nav("/userDashboard/deposit")}
      ...
      {!twoFactor ? (
        <div className="verification-boxes">
          ...
          <div className="verification-text">
            ...
            <p>
              To make your account safer, pls enable{" "}
              <span
                onClick={() => nav("/userDashboard/twoFA")}
                style={{ color: "orange", cursor: "pointer" }}
              >
                2FA
              </span>{" "}
      ...
      {!kyc?.verified ? (
        <div className="verification-boxes">
          ...
          <div className="verification-text">
            ...
            <p>
              Your account will be limited to most transaction,{" "}
              <span
                onClick={() => nav("/userDashboard/kyc")}
                style={{ color: "orange", cursor: "pointer" }}
              >
                Click here
              </span>{" "}
