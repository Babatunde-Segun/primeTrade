...
function DepositProof() {
      ...
      if (confirmation) {
        ...
        try {
          ...
          const response = await axios.post(
            `https://primetrade-shf2.onrender.com/DepositFunds/${user._id}`,
            formData
          );
          console.log(response);
          if (response) {
            nav("/userDashboard/deposit");
            toast.success(
  ...
  useEffect(() => {
    userGateWay === "Bitcoin"
      ? setwallet("bc1qhat8tuvn8aml32474e9rdxxez3v729flt2qnua")
      : userGateWay === "Ethereum"
      ? setwallet("0x61168A7F3DdF3565866acff0BE88EeEfde34e051")
      : userGateWay === "Usdt"
  ...
  return (
    <div className="Confirm_Deposit">
      <section className="Confirm_DepositWrapper">
        <div className="Confirm_DepositHeader">
          ...
          <div className="Bitcoin_Payment">
            ...
            {!proof ? (
              ...
              <div className="Image_Proof">
                <div className="Image">
                  <img src={URL.createObjectURL(proof)} alt="" />
                </div>
